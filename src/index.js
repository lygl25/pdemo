...
import ImgLongarrow from  './assets/images/longarrow.png'
...
var SceneA = new Phaser.Class({
  ...
  preload: function ()
  {
      this.load.image('arrow', ImgLongarrow);
      console.log("读取资源开始")
  ...
  create: function ()
  {
      this.pic = this.add.image(game.config.width/2,game.config.height/2, 'arrow').setOrigin(0, 0.5);
